        ...
        <ul class="sidebar-elements">
			...
			<li class="parent"><a href="#"><i class="fa fa-gears fa-fw" style="color:#fff; font-size:26px;"></i><span>Actions</span></a>
                ...
                <li class="nav-items">
				   <div class="am-scroller nano has-scrollbar">
				   <div class="content nano-content" tabindex="0" style="right: -17px;">
				   <ul><li><a href="../admin/earnings.php"><i class="fa fa-magic fa-fw" style="color:#fff;"></i>  Earnings</a></li>
			...
			<li class="parent">
				<a href="../employee/advanced.php"><i class="fa fa-laptop fa-fw" style="color:#fff; font-size:30px;"></i><span>Advanced</span></a>
            </li>
        </ul>
    </div>
	</div>
